...
/**
 * Step definition for auth_mysignup
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_auth_mysignup extends behat_base {

    /**
     * Emulate clicking on confirmation link from the mysignup
     *
     * @When /^I confirm mysignup for "(?P<username>(?:[^"]|\\")*)"$/
     *
     * @param string $username
     */
    public function i_confirm_mysignup_for($username) {
        global $DB;
