 ...
 * @since      Moodle 3.2
 */
class auth_mysignup_external extends external_api {
    ...
    protected static function check_signup_enabled() {
        ...
        if (empty($CFG->registerauth) or $CFG->registerauth != 'mysignup') {
     ...
     * @param  string $mysignup                  a valid and unique mysignup address
